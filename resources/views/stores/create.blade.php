...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox-content shad">
            ...
            @endif
            <form method="post" action="{{url('/stores')}}" class="form-horizontal form-disabled" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"><input name="address" type="text" class="form-control" value="{{old('address')}}"></div>
                </div>
