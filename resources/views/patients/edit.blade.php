...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox-content shad">
            <h4>Editar perfil de paciente</h4>
            ...
            <form method="post" action="{{url('/patients/'.$patient->id.'/edit')}}" class="form-horizontal form-disabled" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10"><input name="name" type="text" class="form-control" value="{{old('name', $patient->name)}}"></div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label">Apellidos</label>
                    <div class="col-sm-10"><input name="lastName" type="text" class="form-control" value="{{old('lastName',$patient->lastName)}}"></div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label">Edad</label>
                    <div class="col-sm-10"><input name="age" type="text" class="form-control" value="{{old('age',$patient->age)}}"></div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label">Teléfono</label>
                    <div class="col-sm-10"><input name="telephone" type="text" class="form-control" value="{{old('telephone',$patient->telephone)}}"></div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label">Email</label>
                    <div class="col-sm-10"><input name="email" type="text" class="form-control" value="{{old('email',$patient->email)}}"></div>
                </div>
